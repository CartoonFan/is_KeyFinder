...
bool              Preferences::getParallelBatchJobs()         const {
    return parallelBatchJobs;
}
...
int               Preferences::getMaxDuration()               const {
    return maxDuration;
}
QString           Preferences::getITunesLibraryPath()         const {
    return iTunesLibraryPath;
}
QString           Preferences::getTraktorLibraryPath()        const {
    return traktorLibraryPath;
}
QString           Preferences::getSeratoLibraryPath()         const {
    return seratoLibraryPath;
}
QString           Preferences::getMetadataDelimiter()         const {
    return metadataDelimiter;
}
QStringList       Preferences::getCustomKeyCodes()            const {
    return customKeyCodes;
}
QStringList       Preferences::getFilterFileExtensions()      const {
    return filterFileExtensions;
}
QByteArray        Preferences::getBatchWindowState()          const {
    return batchWindowState;
}
...
void Preferences::setMaxDuration(int max)                          {
    maxDuration = max;
}
